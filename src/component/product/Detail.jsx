  ...
  render() {
    return (
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-8 col-md-12 sidebar left-scal">
            <div className="logo">travel web</div>
                ...
                <div className="row">
                  ...
                  <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div className="row">
                      ...
                      <div className="col-10">
                        <p className="pl-title">Time</p>
                        <p className="pl-detail">Jun-August</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-4 col-sm-4 col-12">
                    <div className="row">
                      ...
                      <div className="col-10">
                        <p className="pl-title">Popularity</p>
                        <p className="pl-review">
          ...
          <div className="col-lg-4 col-md-12 right-side right-scal">
